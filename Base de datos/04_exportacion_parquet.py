...
consultas ANALITICAS (OLAP): "promedio de superficie por origen", "conteo por
mes", "suma de acres por estado". Ese tipo de consulta toca pocas columnas pero
muchisimas filas.
...
columna. Esto produce dos ventajas decisivas para el proyecto:
    ...
    1. LECTURA SELECTIVA (projection pushdown). Una consulta que solo necesita
       `superficie_acres` lee unicamente ese bloque del archivo e ignora el
    ...
    2. COMPRESION MUY ALTA. Al estar los valores de una columna juntos, son
       ...
       normalizado pasa de cientos de megabytes a unas pocas decenas.
...
quien clone el proyecto puede ejecutarla sin descargar los 795 MB de la base
cruda de Kaggle.
...
DB_ORIGEN = 'incendios_eeuu_1992_2015.db'
...
# Tablas de hechos: se escriben por lotes para no materializar 1,88 millones de
# filas en memoria durante la exportacion.
TABLAS_GRANDES = ['registro_incendios', 'magnitud_incendio']
